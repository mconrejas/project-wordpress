...
// Load text domain
	function dashboard_to_do_load_plugin_textdomain() {
		load_plugin_textdomain( 'todo', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
	}
	add_action( 'plugins_loaded', 'dashboard_to_do_load_plugin_textdomain' );
